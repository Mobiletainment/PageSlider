...
function PageSlider(container) {
    ...
    this.slidePageFrom = function(page, from) {
        ...
        currentPage.addEventListener('webkitTransitionEnd', function transition(e) {
            currentPage.removeEventListener('webkitTransitionEnd', transition, false); // watch out that the listener is called only once
            var pageToRemove = e.target;
